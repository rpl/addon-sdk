...
const validate = contract({
  ...
  isTargetSupported: {
    ...
    msg: "The `option.isTargetSupported` must be a function"
  }
});
...
const Pane = Class({
  ...
  initialize: function(params={}) {
    ...
    this.isTargetSupported = options.isTargetSupported || ((t) => t.isLocalTab );
...
function registerPane(pane) {
  gDevTools.registerTool({
    ...
    isTargetSupported: pane.isTargetSupported,
