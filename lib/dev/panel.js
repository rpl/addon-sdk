...
// check window chromeFlags for enabled chrome remote window
function chromeRemoteWindowEnabled(window) {
  ...
  if (chromeFlags & Ci.nsIWebBrowserChrome.CHROME_REMOTE_WINDOW) {
    console.log("CHROME_REMOTE_WINDOW chromeFlags enabled: set remote=true");
    return true;
  }
...
build.define(Panel, (proto, window, toolbox, url) => {
  ...
  setAttributes(frame, {
    ...
    "remote": chromeRemoteWindowEnabled(window),
    "type": "content",
    "transparent": true,
    "seamless": "seamless"
  });
